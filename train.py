from __future__ import division # Make / be real floating point division: e.g. 1/2 = 0.5
...
def main():
    ...
    if cfg.get('cudnn_benchmark', False):
        torch.backends.cudnn.benchmark = True # Will make faster if input size is fixed

    if args.resume_from is not None: # Continue training from pretrained model
    ...
    model = MONO.module_dict[model_name](cfg.model) # Remember which model is being used
